...
const searchResults = [
  ...
  "CK & A Professional Consultants Limited",
  "CK & ANGEL HOLDINGS LTD",
  "CK & Associates Limited",
  "CK & ASSOCIATES LIMITED (d2004-10-15",
  "CK & BJ LTD",
  "CK & BL LIMITED",
  "CK & C (HK) Co., Limited",
  "CK & CO LEGAL SERVICES LTD",
  "CK & CO. LTD",
  "CK & CRF FOOTBALL PROJECT LIMITED",
  "CK & D CONSULTING LIMITED",
  "CK & DK CONSULTING LIMITED",
  "CK & DN AGENCIES LTD",
  "CK & DW SPRINKLERS LTD",
  "CK & E LTD",
  "CK & G CONTRACTING LIMITED",
  "CK & G SOLUTIONS LIMITED",
  "CK & G UK LIMITED",
  "CK & H COMPANY LIMITED",
];
