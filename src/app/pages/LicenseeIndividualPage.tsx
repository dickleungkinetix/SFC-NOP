...
export default function LicenseeIndividualPage() {
  ...
  const licenseeRows = useMemo(
    () => [
      {
        organisation: "1 Aden Financial Group Limited",
        role: "Rep",
      ...
      },
      {
        organisation: "",
        role: "Rep",
        activity: "Dealing in securities",
        from: "2019-01-14",
        until: "2019-02-25",
      },
      {
        organisation: "2 CES Capital International (Hong Kong) Co., Limited",
        role: "Rep",
        activity: "Dealing in futures contracts",
        from: "2019-04-15",
        until: "2021-11-19",
      ...
      },
      {
        organisation: "",
        role: "Rep",
        activity: "Advising on securities",
        from: "2019-05-14",
        until: "2021-11-19",
      },
      {
        organisation: "",
        role: "Rep",
        activity: "Leveraged foreign exchange trading",
        from: "2019-05-14",
        until: "2021-11-19",
      },
      {
        organisation: "3 I-ACCESS INVESTORS LIMITED",
        role: "Rep",
        activity: "Dealing in futures contracts",
        from: "2017-12-05",
        until: "2018-11-23",
              ...
              <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6">
                ...
                <div className="mt-4">
                  ...
                  <p className="text-xs text-gray-600 leading-relaxed mt-1">
                    Rep=Representative, RO=Responsible Officer. A person without a
                    starting date was in that role since at least 1-Apr-2003
                    when the current register began.
                  </p>
